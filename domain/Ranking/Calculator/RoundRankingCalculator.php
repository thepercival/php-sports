...
use Sports\Ranking\Calculator\Round\RoundRankingCalculatorForAgainstSport;
use Sports\Ranking\Calculator\Round\RoundRankingCalculatorForTogetherSport;
use Sports\Ranking\Item\RoundRankingItem as RoundRankingItem;
use Sports\Ranking\Item\RoundRankingItemForSport as SportRoundRankingItem;
use SportsHelpers\Sports\TogetherSport;

final class RoundRankingCalculator
{
    /**
     * @var list<GameState>
     */
    ...
    protected function getSportRoundRankingCalculator(CompetitionSport $competitionSport): RoundRankingCalculatorForTogetherSport|RoundRankingCalculatorForAgainstSport
    {
        if ($competitionSport->createSport() instanceof TogetherSport) {
            return new RoundRankingCalculatorForTogetherSport($competitionSport, $this->gameStates);
        }
        return new RoundRankingCalculatorForAgainstSport($competitionSport, $this->gameStates);
    }
